    ...
    <div className="relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 pt-16 pb-20">
        <div className="max-w-4xl mx-auto text-center space-y-6">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-ayurveda-primary/10 backdrop-blur-sm border border-ayurveda-primary/20 text-ayurveda-primary animate-fade-in">
          ...
          <p className="text-lg md:text-xl text-ayurveda-text/90 max-w-2xl mx-auto animate-message-appear delay-100">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-6 animate-message-appear delay-200">
            <Button
              ...
              className="bg-ayurveda-primary hover:bg-ayurveda-primary/90 text-white transition-all duration-300 transform hover:scale-105 text-lg py-6 px-8 rounded-xl shadow-lg hover:shadow-xl w-full sm:w-auto"
            >
            ...
            <Button
              ...
              className="border-ayurveda-primary text-ayurveda-primary hover:bg-ayurveda-primary/10 transition-all duration-300 transform hover:scale-105 text-lg py-6 px-8 rounded-xl shadow-lg hover:shadow-xl w-full sm:w-auto"
            >
